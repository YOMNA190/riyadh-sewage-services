...
const steps = [
  {
    ...
    description: 'اتصل على 0544190082 / 0578342054 أو راسلنا على الواتساب — نجاوبك فوراً',
  },
  {
    number: '2',
    title: 'ننسق وصول الفني',
    description: 'نرسل لك أقرب فني تسليك بالكمبروسر وننسق معك وقت الوصول حسب موقعك',
  },
  {
    number: '3',
