...
const faqs = [
  {
    question: 'كم تكلفة شفط البيارة في الرياض؟',
    answer:
  ...
  {
    question: 'ما هو حجم وايت الشفط؟',
    answer:
      'نستخدم وايتات شفط بأحجام متنوعة من 3,000 إلى 12,000 لتر حسب حاجة الموقع. كل وايتاتنا مجهزة بأحدث تقنيات الشفط والضغط.',
  },
  {
