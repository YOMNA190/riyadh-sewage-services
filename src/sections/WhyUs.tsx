...
const features = [
  {
    ...
    description: 'أسرع خدمة شفط وتسليك في الرياض، نوصلك بوقت قياسي مهما كان الحي.',
  },
  {
    icon: Truck,
    title: 'أحدث المعدات',
    description: 'نستخدم أحدث جيل من كمبروسرات الشفط العملاقة ومعدات الضغط العالي العالمية.',
  },
  {
    icon: Shield,
    title: 'فريق متخصص',
