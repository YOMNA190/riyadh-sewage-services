...
const features = [
  ...
  {
    icon: Clock,
    title: 'تنسيق مرن للمواعيد',
    description: 'ننسق معك موعد الخدمة حسب موقعك وتوفر الفني وحالة الانسداد.',
  },
  {
    icon: CheckCircle,
    title: 'أسعار شفافة',
  ...
  {
    icon: Star,
    title: 'شرح الحل قبل البدء',
    description: 'يوضح الفني طريقة التسليك والتكلفة المتوقعة قبل بدء العمل.',
  },
];
