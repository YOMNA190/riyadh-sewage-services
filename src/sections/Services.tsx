...
const services = [
  ...
  {
    icon: Truck,
    title: 'تسليك مجاري الحمامات بالكمبروسر',
    description:
      'فتح انسداد الحمامات ومواسير الصرف بالكمبروسر مع تنفيذ منظم وتقليل الحاجة إلى التكسير.',
    image: '/images/service-jetting.jpg',
  },
  {
    icon: Wrench,
    title: 'تسليك مجاري المطابخ بالكمبروسر',
    description:
      'معالجة انسداد مجاري المطابخ والتراكمات داخل المواسير باستخدام معدات الضغط المناسبة للحالة.',
    image: '/images/service-jetting.jpg',
  },
];
