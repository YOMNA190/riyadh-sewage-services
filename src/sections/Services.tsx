...
const services = [
  {
    ...
    description:
      'شفط احترافي للبيارات بأحدث وايتات الشفط العملاقة، تنظيف شامل وإزالة الرواسب والمواد العالقة بكفاءة عالية.',
  ...
  },
  {
    ...
    description:
      'ضغط مائي وهوائي عالي القوة لتسليك أصعب الانسدادات في المجاري والأنابيب — حلول فورية وآمنة.',
