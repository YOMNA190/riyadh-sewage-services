...
export default function FloatingWhatsApp() {
  ...
  return (
    <div
      className="fixed z-[80] float-animation"
    ...
    >
      ...
      {showTooltip && (
        <div
          className="absolute right-full mr-3 top-1/2 -translate-y-1/2 whitespace-nowrap px-3 py-2 rounded-lg text-sm font-medium shadow-lg"
          style={{
      ...
      <button
        onClick={handleClick}
        className="w-[60px] h-[60px] rounded-full flex items-center justify-center text-white transition-all hover:scale-110 active:scale-95 shadow-lg relative"
        style={{
          backgroundColor: 'var(--color-whatsapp-green)',
